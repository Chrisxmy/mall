        ...
        <div class="item-list-wrap">
          <div class="cart-item">
            ...
            <ul class="cart-item-list">
              <li v-for="(item,index) in cartList" v-if='cartList && cartList.length > 0'>
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascipt:;" class="checkbox-btn item-check-btn" :class="{check:item.checked === true}" @click='editCart("check",item)'>
        ...
        <div class="cart-foot-wrap">
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
                <span @click='checkout' class="btn btn--red" :class='{"btn--dis":totalPrice === 0}'>Checkout</span>
              </div>
            </div>
          </div>
        </div>
